...
import "../assets/css/player_style.css";
import "../assets/css/plugins/nice_select/nice-select.css";
// import "../assets/css/plugins/player/volume.css";
import "../assets/css/plugins/scroll/jquery.mCustomScrollbar.css";
import "../assets/css/plugins/swiper/css/swiper.min.css";
import volumeSvg from "../assets/images/svg/volume.svg";

const AudioPlayerSection = ({songName, artistName, songUrl, imageUrl}) =>{
                                        ...
                                        <div class="jp-now-playing flex-item">
                                            <div class="jp-track-name">
                                                <span className="que_img">
                                                    <img style={{"width": "50px", "height": "50px", "borderRadius": "50%"}} src={imageUrl} />
                                                </span>
                                                <div className="que_data">
                                                    {songName}
                                                <div class="jp-artist-name">{artistName}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>

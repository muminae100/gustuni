            ...
            <div style={{"backgroundColor": "#1b1b1b", "padding": "20px", "borderRadius": "10px"}}>
                <div style={{"display": "flex", "alignItems": "flex-start", "justifyContent": "space-between"}}>
                    <div style={{"width": "50%"}}>
                        ...
                        <p className="text-success">Please visit <span style={{"textDecoration": "underline"}}>Payments Accounts</span> section and connect your PayPal or Stripe account in order for you to be able to setup a price for this track.</p>
                        <p className="text-white">BASIC LICENSE (MP3) PRICE</p>
                        <input type="text" className="form-control bg-dark text-white" style={{"border": "none"}} defaultValue="29.95" />
                        <p className="text-white">PREMIUM LICENSE (MP3 AND WAV) PRICE</p>
                        <input type="text" className="form-control bg-dark text-white" style={{"border": "none"}} defaultValue="49.95" />
                        <p>Note: You may customize your Licenses through here: <span className="text-success">Licenses & Contracts</span></p>
                        <p>To disable a License for this specific Track please enter 0 (or 0.00). This will disable purchases for that specific license.</p>
                    </div>
                    <div>
                        <h6 className="text-white">FREE DOWNLOAD OPTIONS</h6>
                        <input type="radio" /> <label htmlFor="" className="text-white">No</label><br />
                        <input type="radio" /> <label htmlFor="" className="text-white">Yes with voice tag (MP3 Version)</label><br />
                        ...
                        <p className="text-white">REQUIRE DOWNLOADERS TO</p>
                        <input type="radio" /> <label htmlFor="" className="text-white">Capture email only</label>

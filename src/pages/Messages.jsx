            ...
            <div class="row">
              <div class="col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0">
                ...
                <div class="p-3">
                  ...
                  <div data-mdb-perfect-scrollbar="true" style={{"position": "relative", "height": "500px", "overflowY": "scroll"}}>
              ...
              <div class="d-flex flex-row justify-content-start bg-white" style={{"position": "sticky", "top": 0}}>
                      <h5 class="text-dark font-weight-bold mb-3">Marie Horwitz</h5>
                      <p class="small ms-3 mb-3 rounded-3 text-muted float-end">Sun 7 Aug 2022</p>
                    </div>
